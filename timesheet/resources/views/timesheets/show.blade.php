        ...
        <div class="px-6 py-8 sm:p-8">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div class="sm:text-right">
                    <p class="text-lg text-gray-600">Employee Initial: {{ $timesheet->empInitial }}</p>
            ...
            <div class="mt-4">
                ...
                <div class="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2">
                    @if($timesheet->status)
                    <p class="text-lg text-gray-600">Status (DO): {{ $timesheet->status }}</p>
                    @endif
                    @if($timesheet->vacCtOther)
                    <p class="text-lg text-gray-600">Vacation/CT Other: {{ $timesheet->vacCtOther }}</p>
                    @endif
                </div>
            </div>
            @endif
