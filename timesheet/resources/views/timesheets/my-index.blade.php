    ...
    <div class="py-4 mb-2">
        <form method="GET" action="/my-timesheets" class="flex flex-wrap gap-6 items-end">
            ...
            <div class="flex-shrink-0">
                <button type="submit" class="inline-flex items-center px-1 py-0.5 border border-transparent text-xs font-medium rounded text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Apply Filter
                </button>
            </div>
        </form>
