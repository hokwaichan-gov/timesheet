            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input name="first_name" id="first_name" type="first_name" required></x-form-input>
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input name="last_name" id="last_name" type="last_name" required></x-form-input>
